...
from jev_atari import candidate_study as criteria_study
from jev_atari.candidate_study import CandidateBudget as CriteriaBudget
from jev_atari.choice import ActionProgram
from jev_atari.io import read_json, write_json
from jev_atari.openrouter import OpenRouterChoiceEvaluator as ChoiceEvaluator
...
def test_full_probe_roundtrip_and_tampering(tmp_path, monkeypatch):
    ...
    auditor = importlib.import_module("verify_candidate_study")
